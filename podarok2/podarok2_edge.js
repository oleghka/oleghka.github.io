...
"stage": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: false,
            timeline: [
                { id: "eid252", tween: [ "style", "${_plashka}", "opacity", '0', { fromValue: '1'}], position: 3734, duration: 167 },
                ...
                { id: "eid61", tween: [ "transform", "${_Ellipse2}", "scaleY", '1', { fromValue: '0'}], position: 0, duration: 500, easing: "easeOutBounce" },
                { id: "eid205", tween: [ "style", "${_plashka}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [328.85546875,0]}], position: 2466, duration: 634, easing: "easeOutBounce" },
                ...
                { id: "eid62", tween: [ "transform", "${_Ellipse2}", "scaleX", '1', { fromValue: '0'}], position: 0, duration: 500, easing: "easeOutBounce" },
                { id: "eid210", tween: [ "style", "${_text}", "opacity", '1', { fromValue: '0'}], position: 3100, duration: 233 },
                { id: "eid256", tween: [ "style", "${_text}", "opacity", '0', { fromValue: '1'}], position: 3734, duration: 167 }            ]
        }
    }
}
};
